...
public class  LifeExpectancy extends PApplet {
	...
	public void setup() {
		...
		LifeExpMap = ParseFeed.loadLifeExpectancyFromCSV(this,"API_SP.POP.TOTL_DS2_en_csv_v2.csv");
	...
	public void draw() {
		background(200);// Draw map tiles and country markers
		map.draw();
	}
	...
	private void shadeCountries() {
		for (Marker marker : countryMarkers) {
			...
			if (LifeExpMap.containsKey(countryId)) {
				...
				int colorLevel = (int) map(lifeExp, 0, 1500000000, 10, 255);
